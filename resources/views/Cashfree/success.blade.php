...
<head>
    <meta charset="UTF-8">
    <title>Payment Success - Cashfree</title>
...
<div class="success-container">
    ...
    <table class="details-table">
        ...
        <tr>
            <th>Status</th>
            <td><strong style="color: green;">{{ ucfirst($status ?? 'success') }}</strong></td>
        </tr>
    </table>
...
<script>
    ...
    const interval = setInterval(() => {
        ...
        if (seconds <= 0) {
            ...
            window.location.href = "http://127.0.0.1:8000/cashfree/checkout"; // Your Cashfree payment start page
        }
    }, 1000);
</script>
